...
## 生命周期篇<Badge type="info" text="default" />

### 初始化函数——initEvents<Badge type="tip" text="^1.9.0" />
...
### 初始化函数——initInjections<Badge type="warning" text="beta" />
...
### 初始化函数——initState<Badge type="danger" text="caution" />
...
### 模版编译阶段<Badge type="info">自定义</Badge>
